...
// #define LSM6DS3_ACC_GYRO_SENSOR_SYNC_TIME  		0X04 Removed in LSM6DS0: 0x03- 0x06 Reserved NOT USED in CPP
// #define LSM6DS3_ACC_GYRO_SENSOR_SYNC_EN  		0X05 NOT USED in CPP

// Increment all by one due to RESERVED registers
#define LSM6DS3_ACC_GYRO_FIFO_CTRL1  			0X07
#define LSM6DS3_ACC_GYRO_FIFO_CTRL2  			0X08
#define LSM6DS3_ACC_GYRO_FIFO_CTRL3  			0X09
#define LSM6DS3_ACC_GYRO_FIFO_CTRL4  			0X0A

// #define LSM6DS3_ACC_GYRO_FIFO_CTRL5  			0X0A Removed in LSM6DS0
// #define LSM6DS3_ACC_GYRO_ORIENT_CFG_G  			0X0B NOT USED in CPP
// #define LSM6DS3_ACC_GYRO_REFERENCE_G  			0X0C NOT USED in CPP
...
// #define LSM6DS3_ACC_GYRO_MASTER_CONFIG  		0X1A NOT USED IN CPP
#define LSM6DS3_ALL_INT_SRC  		0X1A // Added - output only i.e. READ
...
//#define LSM6DS3_ACC_GYRO_OUTX_L_XL  			0X28 // ----------OLD NAME -------
...
#define LSM6DS3_ACC_GYRO_OUTX_L_A  			0X28 // ----------NEW NAME -------
#define LSM6DS3_ACC_GYRO_OUTX_H_A  			0X29
#define LSM6DS3_ACC_GYRO_OUTY_L_A  			0X2A
#define LSM6DS3_ACC_GYRO_OUTY_H_A  			0X2B
#define LSM6DS3_ACC_GYRO_OUTZ_L_A  			0X2C
#define LSM6DS3_ACC_GYRO_OUTZ_H_A  			0X2D // ------------^^------------

//  #define LSM6DS3_ACC_GYRO_SENSORHUB1_REG  		0X2E Reserved 0x2E - 0x34 NOT  USED in CPP ------------
...
//#define LSM6DS3_ACC_GYRO_SENSORHUB8_REG  		0X35 //------Replaced NOT USED---------
...
//#define LSM6DS3_ACC_GYRO_FIFO_STATUS3  			0X3C //------Replaced ------NOT // USED
//#define LSM6DS3_ACC_GYRO_FIFO_STATUS4  			0X3D NOT USED

//#define LSM6DS3_ACC_GYRO_FIFO_DATA_OUT_L  		0X3E  FIND REPLACEMENT
//#define LSM6DS3_ACC_GYRO_FIFO_DATA_OUT_H  		0X3F ////--------^^-------------FIND REPLACEMENT
...
#define LSM6DS3_ACC_GYRO_TIMESTAMP3_REG  		0X43 // Added

// #define LSM6DS3_ACC_GYRO_STEP_COUNTER_L  		0X4B Reserved 0x44-55 NOT USED
// #define LSM6DS3_ACC_GYRO_STEP_COUNTER_H  		0X4C NOT USED
// #define LSM6DS3_ACC_GYRO_FUNC_SRC  			0X53 NOT USED

#define LSM6DS3_ACC_GYRO_TAP_CFG0  			0X56 // Added
#define LSM6DS3_ACC_GYRO_TAP_CFG1  			0X57 // Changed to 0x57
#define LSM6DS3_ACC_GYRO_TAP_CFG2  			0X58 // Added
...
#define LSM6DS3_ACC_GYRO_I3C_BUS_AVB         0x62 //Added
#define LSM6DS3_ACC_GYRO_INTERNAL_FREQ_FINE         0x63 //Added
//#define LSM6DS3_ACC_GYRO_ADDR0_TO_RW_RAM         0x62 Removed
//#define LSM6DS3_ACC_GYRO_ADDR1_TO_RW_RAM         0x63 Removed

// #define LSM6DS3_ACC_GYRO_DATA_TO_WR_RAM          0x64 // ---- Reserved ----
// #define LSM6DS3_ACC_GYRO_DATA_RD_FROM_RAM        0x65 // ------^^----------
 
#define LSM6DS3_ACC_GYRO_INT_OIS         0x6F //Added
#define LSM6DS3_ACC_GYRO_CTRL1_OIS         0x70 //Added
#define LSM6DS3_ACC_GYRO_CTRL2_OIS         0x71 //Added
#define LSM6DS3_ACC_GYRO_CTRL3_OIS         0x72 //Added
#define LSM6DS3_ACC_GYRO_X_OFS_USR         0x73 //Added
#define LSM6DS3_ACC_GYRO_Y_OFS_USR         0x74 //Added
#define LSM6DS3_ACC_GYRO_Z_OFS_USR         0x75 //Added

#define LSM6DS3_ACC_GYRO_FIFO_DATA_OUT_TAG         0x78 //Added
#define LSM6DS3_ACC_GYRO_FIFO_DATA_OUT_X_L         0x79 //Added
#define LSM6DS3_ACC_GYRO_FIFO_DATA_OUT_X_H         0x7A //Added
#define LSM6DS3_ACC_GYRO_FIFO_DATA_OUT_Y_L         0x7B //Added
#define LSM6DS3_ACC_GYRO_FIFO_DATA_OUT_Y_H         0x7C //Added
#define LSM6DS3_ACC_GYRO_FIFO_DATA_OUT_Z_L         0x7D //Added
#define LSM6DS3_ACC_GYRO_FIFO_DATA_OUT_Z_H         0x7E //Added
